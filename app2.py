...
if df_data is not None and not df_data.empty:
    ...
    # 3️⃣ Filtro Etapa (Dropdown simples)
    etapas_disponiveis = sorted(df_filtered["Etapa"].dropna().unique())
    etapas_list = ["Todos"] + etapas_disponiveis
    selected_etapa = st.sidebar.selectbox("Filtrar por Etapa", etapas_list)
    if selected_etapa != "Todos":
        df_filtered = df_filtered[df_filtered["Etapa"] == selected_etapa]
...
#========================================================================================================
    ...
    with tab2:
        ...
        <div style="margin-top: 10px; font-size: 12px; color: #555;">
            ...
            <span style="color: #A38408; font-weight: bold;">■ Atrasado na execução</span> | 
            <span style="color: #000000; font-weight: bold;">■ Em andamento normal</span> | 
